# nvim-treesitter-queries-tsx

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tsx/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tsx/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tsx**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tsx",
...
- [ ] Changes are scoped to `tsx` — do not include files for other languages
